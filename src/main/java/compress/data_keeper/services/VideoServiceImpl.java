...
import compress.data_keeper.constants.MediaFormats;
...
import compress.data_keeper.exception_handler.server_exception.exceptions.VideoCompessException;
import compress.data_keeper.exception_handler.server_exception.exceptions.MinioGetUrlException;
    ...
    private void savePreviewPictures(Path filePath, Path picturePath, String originalFilename) {
        ...
        try (FFmpegFrameGrabber grabber = new FFmpegFrameGrabber(filePathStr)) {
            ...
            if (image != null) {
                ...
                dataStorageService.uploadFIle(bais, picturePath.toString(), originalFilename);
